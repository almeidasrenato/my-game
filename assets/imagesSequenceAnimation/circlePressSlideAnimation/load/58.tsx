...
const SVGComponent = (props) => (
  ...
  >
    ...
    <G opacity={0.04}>
      <Path
        d="M270 295.385L270 287L160 402L270 517L270 508.615"
        stroke="#148B91"
        strokeWidth={20}
      />
      <Path
        d="M530 508.615L530 517L640 402L530 287L530 295.385"
        stroke="#148B91"
        strokeWidth={20}
      />
      <Path
        d="M215 328.724L215 323L140 401.5L215 480L215 474.276"
        stroke="#148B91"
        strokeWidth={4}
      />
      <Path
        d="M585 474.276L585 480L660 401.5L585 323L585 328.724"
        stroke="#148B91"
        strokeWidth={4}
      />
    </G>
